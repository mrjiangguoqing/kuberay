...
def build_app(cli_args: Dict[str, str]) -> serve.Application:
    ...
    bundles=[{"CPU":20,"GPU": 1},{"CPU":20,"GPU": 1},{"CPU":20,"GPU": 1},{"CPU":20,"GPU": 1}]
    #bundles=[{"CPU":7,"GPU": 1}]
